...
const LayoutProtegido = () => {
  ...
  // Manejar el scroll de la página principal para cerrar la barra de notificaciones en móvil
  useEffect(() => {
    ...
    // Remover el listener de scroll al desmontar el componente o si deja de ser móvil
    return () => {
      window.removeEventListener("scroll", handleMainScroll);
    };
  }, [isMobile, notificacionesVisibles]);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 shadow-lg transition-transform transform">
            ...
            <button
              ...
              `}
            > {/* VALORES QUE SE UTILIZARON PARA ALINEAR EL XMARKICON A TODAS LAS RESOLUCIONES*/}
      ...
      {notificacionesVisibles && (
        <div
          className="absolute top-16 md:top-0 right-0 z-50 w-11/12 sm:w-8/12 md:w-70vw max-w-full p-4 md:p-6"
        >
...
export default LayoutProtegido;///////ULTIMO
